...
class Mogi(scrapy.Spider):
    ...
    def parse_url(self, response):
        article_urls = response.css('.pgjTolSNq4-L--tpQ7Xp5 .-AGAL8Zp7YDoV-PVebFY0 ._3qr34_XMQROJG0YnuXtt9c a._3JMKvS6hucA6KaM9tX3Qb1::attr(href)').extract()
        print('HAHAHAHAHAHAHAHAHAHAHA', article_urls)
